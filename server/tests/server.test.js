...
describe('DELETE /todos/:id', () =>{
  ...
  it('should not remove a todo by wrong user', (done) =>{
...
describe('GET /users/me', () =>{
  it('should return a user if authenticated version 1', (done) =>{
    request(app)
      .get('/users/me')
      .set('x-auth', users[0].tokens[0].token)
      .expect(200)
